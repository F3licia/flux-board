...
export function DrawerMobileToggle({ isOpen, onToggle }: ToggleTrigger) {
  ...
  return (
    <div
      onClick={onToggle}
      className="block md:hidden fixed top-0 rigth-0 pt-4 pl-4 pr-4 pb-4 z-50 min-w-full text-box border-y-def">
      <div className="absolute top-1/2 -translate-y-1/2 text-2xl text-box">
